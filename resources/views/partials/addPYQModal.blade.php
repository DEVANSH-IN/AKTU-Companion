<!-- Bootstrap 5 Modal -->
<div class="modal fade" id="addPYQModal" tabindex="-1" aria-labelledby="addPyqModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content rounded-3 shadow">
            ...
            <form id="add-pyq" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="examination_year" name="examination_year"
